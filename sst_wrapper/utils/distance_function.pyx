...
class TriStateDistance(_sst_module.IDistance):
    ...
    def distance(self,double[:] point1,double[:] point2):
        return ((point1[0]-point2[0])**2 +(point1[1]-point2[1])**2+ normalize_angle(point1[2]-point2[2])**2 +(point1[3]-point2[3])**2+(point1[4]-point2[4])**2+normalize_angle(point1[5]-point2[5])**2)**0.5
